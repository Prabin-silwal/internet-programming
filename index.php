...
$connect = new PDO("mysql:host=localhost;dbname=ipdatabase", "root", "");
...
if(isset($_POST["action"]))
{
	...
	$mail->Username = 'psilwal50@gmail.com';					//Sets SMTP username
	$mail->Password = '';					//Sets SMTP password
	$mail->SMTPSecure = '';							//Sets connection prefix. Options are "", "ssl" or "tls"
	$mail->From = 'psilwal50@gmail.com';			//Sets the From email address for the message
	$mail->FromName = 'Buy and Sell';			//Sets the From name of the message
	...
	{
		$message = '<label class="text-success">failed...</label>';
	}
	unlink($file_name);
}
