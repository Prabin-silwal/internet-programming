...
echo '<li class="nav-item "><a class="navbar-brand" href="'. $reco['link'] .'">'. $reco['menus'];'</a></li>'; 
 ...
 else
 {
  ...
  <?php
  $id=$_GET['id'];
  $s="SELECT * FROM images where id=$id";
...
<div class="form-group">
  ...
  <input type="text" class="form-control" id="usr" name="imagename" placeholder="image name" required="required" value="<?php echo $r['imagename']?>">
</div>    
<div class="form-group">
  <label for="usr"> Brand Name:</label>
  <input type="text" class="form-control" id="usr" name="brandname" placeholder="Brand Name" value="<?php echo $r['brand']?>" >
</div> 
<div class="form-group">
  <label for="usr"> Price:</label>
  <input type="text" class="form-control" id="usr" name="price" placeholder="price" required="required" value="<?php echo $r['price']?>">
</div> 
...
<div class="btn-group btn-group-toggle" data-toggle="buttons">
  ...
  <textarea class="form-control" rows="5" name="description"   required="required"> <?php echo $r['description']?></textarea>
</div> 
<img src="<?php echo $r['name']?>">
...
if(!empty($_FILES['image']))
{
  ...
  {
     $sql="UPDATE images SET name='$path',email='$username',imagename='$imagename',price='$price',description='$description',negotiable='$negotiable',quality='$quality',brand='$brand',category='$catagory' where id=$id";
